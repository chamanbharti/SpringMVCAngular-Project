...
<tr>
	<td  class=yellowtext>Product Id</td>
	<td><html:text property="product_id" /></td>
</tr>

<tr>
	<td class=yellowtext>Category Id</td>
	<td><input type=text value="<%=(String)request.getParameter("category_id")%>" name=category_id >
	</td>
</tr>
<tr>
	<td  class=yellowtext>Product's Name</td>
	<td><html:text property="name" /></td>
</tr>
<tr>
	<td  class=yellowtext>Description</td>
	<td><html:text property="description" /></td>
</tr>
<tr>
	<td class=yellowtext>Price</td>
