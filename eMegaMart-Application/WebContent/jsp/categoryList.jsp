...
<html>
<head>
<title>www.emega-mart.com</title>
...
<td width="750" valign=top>
	...
	<tr bgcolor="#AE62AC" class=boldwhite>
	...
	<logic:iterate id="category" name="categories">
		<tr align="center" bgcolor="#AE62AC">
			...
			<td>			
				<a href="../do/GetCategory?category_id=<bean:write name="category" property="category_id" />">
				Update
				</a>
			</td>
			<td>
				<a href="../do/DeleteCategory?category_id=<bean:write name="category" property="category_id" />">
				Delete
				</a>
			</td>
			<td>
				<a href="../do/ShowProduct?category_id=<bean:write name="category" property="category_id" />">
				Show Products
				</a>
			</td>
			<td bgcolor="#AE62AC">
				<a href="../jsp/addProduct.jsp?category_id=<bean:write name="category" property="category_id" />">
				Add Products
				</a>
			</td>
		</tr>
	...
	<tr><td align=center><a href="/eMegaMart-Application/jsp/logout.jsp" >Logout</a></td></tr>
	</table>
